...
## reorder species 
surveys_wide <- svy_w1 %>% ungroup %>% filter(year==1977) %>%
...
surveys_long <- surveys_wide %>%
  gather(key = genus, value = mean_weight, -(month:plot_id))
